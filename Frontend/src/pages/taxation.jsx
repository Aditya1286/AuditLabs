                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10 mb-8 hover:shadow-xl transition-shadow duration-300">
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div className="flex-1">
                                    <TextReveal delay={0.3} text="What is Taxation?" className="font-bold text-2xl md:text-3xl text-[#0C2B4E] mb-4" />
                                </div>
                            </div>
                            <BlockReveal>
                    ...
                    <BlockReveal>
                        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-10 mb-8 hover:shadow-xl transition-shadow duration-300">
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div className="flex-1">
                                    <TextReveal delay={0.3} text="What is Return Filing?" className="font-bold text-2xl md:text-3xl text-[#0C2B4E] mb-4" />
                                </div>
                            </div>
                            <BlockReveal>
                                <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                    ...
                    <BlockReveal>
                        <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 lg:p-10 mb-8 hover:shadow-xl transition-shadow duration-300">
                            <div className="flex flex-col sm:flex-row items-start gap-4 mb-6">
                                ...
                                <div className="flex-1">
                                    <TextReveal delay={0.3} text="How Return Filing Works: The Process" className="font-bold text-xl md:text-2xl lg:text-3xl text-[#0C2B4E] mb-4 md:mb-6" />
                                </div>
                            </div>
                            <BlockReveal>
